    ...
    <div class="d-flex flex-row">
        <div class="col-md-3">
            <div class="card card1 p-3">
                <div class=" image d-flex flex-row align-items-center mt-3" style="border-radius:20px;"><img src="img/Chandan.jpeg"  height="50" width="50"/> <span style="font-size:20px; margin-left:10px;">Chandan Dalaui</span> </div>
                <hr class="hline">
